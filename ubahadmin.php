        ...
        <div class="control-group">
          ...
          <div class="control-group">
            ...
            <input class="form-control"  type="text-centert" name="pass"  placeholder="Password" value="<?php echo $data['pass']; ?>" required="required">
             ...
             <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
            <input class="form-control"  type="text" name="level" placeholder="level" value="<?php echo $data['level']; ?>" readonly></div>
          </div>
          </div>
...
if (isset($_POST['submit'])) 
{
  ...
  $sql = mysqli_query($konek,"UPDATE user SET  username = '$username', pass = '$pass',level = '$level' WHERE id_user = '$id_user'"); ?>

   <script language="JavaScript">alert('Data Admin Berhasil Diubah!!!');
